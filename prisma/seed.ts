...
async function main() {
  ...
  const skills = [
      { 
        name: 'HTML', 
        description: 'Proficient in HTML fundamentals, semantic markup, and modern HTML5 features for web structure', 
        icon: skillLogos['HTML'], 
        category: 'Front-End' 
      }, 
      { 
        name: 'CSS', 
        description: 'Skilled in CSS styling, responsive design, animations, and modern layout techniques', 
        icon: skillLogos['CSS'], 
        category: 'Front-End' 
      }, 
      { 
        name: 'JavaScript', 
        description: 'Proficient in JavaScript fundamentals, DOM manipulation, and interactive web development', 
        icon: skillLogos['JavaScript'], 
        category: 'Front-End' 
      },
      { 
        name: 'React', 
        description: 'Building dynamic user interfaces with React components, hooks, and modern state management', 
        icon: skillLogos['React'], 
        category: 'Front-End' 
      },
      { 
        name: 'Next.js', 
        description: 'Developing modern web applications with Next.js, React, and server-side rendering', 
        icon: skillLogos['Next.js'], 
        category: 'Front-End' 
      },
      { 
        name: 'Python', 
        description: 'Experienced in Python for data analysis, machine learning, automation, and web development', 
        icon: skillLogos['Python'], 
        category: 'Programming' 
      },
      { 
        name: 'Flask', 
        description: 'Developing lightweight web applications and RESTful APIs using Python Flask framework', 
        icon: skillLogos['Flask'], 
        category: 'Back-End' 
      },
      { 
        name: 'Laravel', 
        description: 'Creating robust web applications using Laravel PHP framework with MVC architecture', 
        icon: skillLogos['Laravel'], 
        category: 'Back-End' 
      },
      { 
        name: 'MySQL', 
        description: 'Proficient in relational database design, complex queries, and data management optimization', 
        icon: skillLogos['MySQL'], 
        category: 'Database' 
      }, 
      { 
        name: 'PostgreSQL', 
        description: 'Working with advanced relational database features, indexing, and complex query optimization', 
        icon: skillLogos['PostgreSQL'], 
        category: 'Database' 
      },
      { 
        name: 'Power BI', 
        description: 'Creating interactive dashboards and data visualizations for business intelligence and insights', 
      ...
      { 
        name: 'Flutter', 
        description: 'Building cross-platform mobile applications with Flutter framework and Dart language', 
        icon: skillLogos['Flutter'], 
        category: 'Mobile' 
      },
      { 
        name: 'Git', 
        description: 'Version control management, collaborative development workflows, and repository maintenance', 
        icon: skillLogos['Git'], 
        category: 'Tools' 
      }
    ]
